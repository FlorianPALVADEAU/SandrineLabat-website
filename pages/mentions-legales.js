...
function mentionsLegales() {
  return (
    ...
    <div className={style.content2}>
        <p><strong>Nom des éditeurs :</strong> Florian PALVADEAU & Sandrine LABAT</p>
        <p><strong>Adresse :</strong> 21 rue des coteaux de châtrons, 78760, Saint-Germain-De-La-Grange</p>
        <p><strong>Adresse e-mail :</strong> florian.plvd@gmail.com & sandrinelabat@gmail.com</p>
        <p><strong>Responsable de la publication :</strong> Sandrine LABAT</p>
    </div>
